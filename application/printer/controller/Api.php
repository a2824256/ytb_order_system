...
//    private $url = "115.28.15.113:60003/?";
    ...
    public function printOrder($billoid)
    {
        ...
        $order = Db::table('order')->where(['order_number' => $oid])->field('user_name,user_post_code,user_telephone,user_address,bid,comment,total_price,order_number,create_time')->find();
        $goods = Db::table('order_goods')->where(['order_number' => $oid])->column('gid,good_name,num,price,total_price');
